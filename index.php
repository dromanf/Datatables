...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="#" target="_blank">Sistemas</a>                   
                </div>
            </div>
            <!-- /navbar-inner -->
        </div><br />
        ...
        <div class="footer span-12">
            <div class="container">
              <center> <b class="copyright"><a href="#"> Sistemas</a> &copy; <?php echo date("Y")?> DataTables Bootstrap </b></center>
            </div>
        </div>
